...
class JSDOM {
    ...
    static fromURL(url, options = {}) {
        return Promise.resolve().then(() => {
            ...
            const resourceLoader = resourcesToResourceLoader(options.resources, options);
...
function transformOptions(options, encoding, mimeType) {
    ...
    transformed.windowOptions.resourceLoader = resourcesToResourceLoader(options.resources, options);
...
function resourcesToResourceLoader(resources, options) {
    switch (resources) {
        case undefined:
            {
                // return new NoOpResourceLoader();
                return new NoOpResourceLoader(options);
            }
        case "usable":
            {
